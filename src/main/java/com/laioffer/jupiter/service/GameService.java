...
//@Service
//public class GameService {
//    private static final String TOKEN = "Bearer qofzvdq88lu9ebtfsrjkieufw48j0w";
//    private static final String CLIENT_ID = "sovgkwgr1cl2vgycxt6uuh4kejps5g";
//    private static final String TOP_GAME_URL = "https://api.twitch.tv/helix/games/top?first=%s";
//    private static final String GAME_SEARCH_URL_TEMPLATE = "https://api.twitch.tv/helix/games?name=%s";
//    private static final int DEFAULT_GAME_LIMIT = 20;
//
...
//        } catch (JsonProcessingException e) {
//            e.printStackTrace();
//            throw new RuntimeException("Fail to parse game date from twitch API");
//        }
//    }
//
//    // Integrate search() and getGameList() together, returns the top x popular games from Twitch.
