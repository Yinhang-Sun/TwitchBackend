...
public class GameService {
    ...
    // Integrate search() and getGameList() together, return the dedicated game base on the game name.
    ...
    // Return the top x streams based on game ID.
    ...
    // Return the top x clips based on game ID.
