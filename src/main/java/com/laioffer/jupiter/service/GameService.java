...
public class GameService {
    private static final String TOKEN = "Bearer TWITCH_ACCESS_TOKEN";
    ...
    // eg., https://api.twitch.tv/helix/games/top when trying to get to games.
    private String buildGameURL(String url, String gameName, int limit) {
        if(gameName.equals("")) {
            return String.format(url, limit);
        } else {
            try {
                // Encode special characters in URL, eg., Jonathan Sun -> Jonathan%20Sun
